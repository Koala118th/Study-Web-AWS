                ...
                <ol>
                    ...
                    <li>
                        ...
                        <div className="note-box">
                            <strong>Note:</strong>
                            {" "}
                            us-east-1 region has the
                            cheapest pricing, but if
                            you set up the EC2 instance
                            in a different region, you
                            may incur additional data
                            transfer costs.
                        </div>
                    </li>
